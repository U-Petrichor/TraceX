...
# Configuration
SOURCE_FILE = os.path.join(project_root, "analyzer", "test", "apt_events", "direct", "APT29.jsonl")
...
def main():
    print("🚀 Starting APT29 Attack Simulation Ingestion...")
    ...
    try:
        ...
        marker_path = os.path.join(project_root, "web", "backend", "active_simulations", "APT29.jsonl")
        try:
    ...
    print("🏁 APT29 Simulation complete.")
