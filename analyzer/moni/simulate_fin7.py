...
# Configuration
SOURCE_FILE = os.path.join(project_root, "analyzer", "test", "apt_events", "direct", "FIN7.jsonl")
...
def main():
    print("🚀 Starting FIN7 Attack Simulation Ingestion...")
    ...
    try:
        ...
        marker_path = os.path.join(project_root, "web", "backend", "active_simulations", "FIN7.jsonl")
        try:
    ...
    print("🏁 FIN7 Simulation complete.")
