...
# Configuration
SOURCE_FILE = os.path.join(project_root, "analyzer", "test", "apt_events", "direct", "LuminousMoth.jsonl")
...
def main():
    print("🚀 Starting LuminousMoth Attack Simulation Ingestion...")
    ...
    try:
        ...
        marker_path = os.path.join(project_root, "web", "backend", "active_simulations", "LuminousMoth.jsonl")
        try:
    ...
    print("🏁 LuminousMoth Simulation complete.")
