...
# Configuration
SOURCE_FILE = os.path.join(project_root, "analyzer", "test", "apt_events", "direct", "APT28.jsonl")
...
def main():
    print("🚀 Starting APT28 Attack Simulation Ingestion...")
    ...
    try:
        ...
        marker_path = os.path.join(project_root, "web", "backend", "active_simulations", "APT28.jsonl")
        try:
    ...
    print("🏁 APT28 Simulation complete.")
